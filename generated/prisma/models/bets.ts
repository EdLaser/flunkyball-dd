...
export type BetsAvgAggregateOutputType = {
  bet_amount: runtime.Decimal | null
  odds_at_bet_time: runtime.Decimal | null
...
export type BetsGroupByOutputType = {
  ...
  bet_amount: runtime.Decimal
  odds_at_bet_time: runtime.Decimal
  potential_payout: runtime.Decimal
  status: $Enums.bet_status
  settled_at: Date | null
  _count: BetsCountAggregateOutputType | null
  _avg: BetsAvgAggregateOutputType | null
  _sum: BetsSumAggregateOutputType | null
...
export type betsWhereInput = {
  ...
  bet_id?: Prisma.UuidFilter<"bets"> | string
  created_at?: Prisma.DateTimeFilter<"bets"> | Date | string
  user_id?: Prisma.UuidFilter<"bets"> | string
  match_id?: Prisma.UuidFilter<"bets"> | string
  predicted_winner?: Prisma.UuidFilter<"bets"> | string
  bet_amount?: Prisma.DecimalFilter<"bets"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  odds_at_bet_time?: Prisma.DecimalFilter<"bets"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  potential_payout?: Prisma.DecimalFilter<"bets"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  status?: Prisma.Enumbet_statusFilter<"bets"> | $Enums.bet_status
  settled_at?: Prisma.DateTimeNullableFilter<"bets"> | Date | string | null
...
export type betsOrderByWithRelationInput = {
  ...
  predicted_winner?: Prisma.SortOrder
  bet_amount?: Prisma.SortOrder
  odds_at_bet_time?: Prisma.SortOrder
...
export type betsScalarWhereWithAggregatesInput = {
  ...
  bet_id?: Prisma.UuidWithAggregatesFilter<"bets"> | string
  created_at?: Prisma.DateTimeWithAggregatesFilter<"bets"> | Date | string
  user_id?: Prisma.UuidWithAggregatesFilter<"bets"> | string
  match_id?: Prisma.UuidWithAggregatesFilter<"bets"> | string
  predicted_winner?: Prisma.UuidWithAggregatesFilter<"bets"> | string
  bet_amount?: Prisma.DecimalWithAggregatesFilter<"bets"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  odds_at_bet_time?: Prisma.DecimalWithAggregatesFilter<"bets"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  potential_payout?: Prisma.DecimalWithAggregatesFilter<"bets"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  status?: Prisma.Enumbet_statusWithAggregatesFilter<"bets"> | $Enums.bet_status
  settled_at?: Prisma.DateTimeNullableWithAggregatesFilter<"bets"> | Date | string | null
}

export type betsCreateInput = {
  bet_id?: string
  created_at?: Date | string
  bet_amount: runtime.Decimal | runtime.DecimalJsLike | number | string
  odds_at_bet_time: runtime.Decimal | runtime.DecimalJsLike | number | string
...
export type betsUpdateInput = {
  bet_id?: Prisma.StringFieldUpdateOperationsInput | string
  created_at?: Prisma.DateTimeFieldUpdateOperationsInput | Date | string
  bet_amount?: Prisma.DecimalFieldUpdateOperationsInput | runtime.Decimal | runtime.DecimalJsLike | number | string
  odds_at_bet_time?: Prisma.DecimalFieldUpdateOperationsInput | runtime.Decimal | runtime.DecimalJsLike | number | string
  potential_payout?: Prisma.DecimalFieldUpdateOperationsInput | runtime.Decimal | runtime.DecimalJsLike | number | string
  status?: Prisma.Enumbet_statusFieldUpdateOperationsInput | $Enums.bet_status
  settled_at?: Prisma.NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  users?: Prisma.usersUpdateOneRequiredWithoutBetsNestedInput
  matches?: Prisma.matchesUpdateOneRequiredWithoutBetsNestedInput
  teams?: Prisma.teamsUpdateOneRequiredWithoutBetsNestedInput
}
...
export type betsUncheckedUpdateInput = {
  ...
  predicted_winner?: Prisma.StringFieldUpdateOperationsInput | string
  bet_amount?: Prisma.DecimalFieldUpdateOperationsInput | runtime.Decimal | runtime.DecimalJsLike | number | string
  odds_at_bet_time?: Prisma.DecimalFieldUpdateOperationsInput | runtime.Decimal | runtime.DecimalJsLike | number | string
  potential_payout?: Prisma.DecimalFieldUpdateOperationsInput | runtime.Decimal | runtime.DecimalJsLike | number | string
  status?: Prisma.Enumbet_statusFieldUpdateOperationsInput | $Enums.bet_status
...
export type Enumbet_statusFieldUpdateOperationsInput = {
  set?: $Enums.bet_status
}
...
export type betsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"bet_id" | "created_at" | "user_id" | "match_id" | "predicted_winner" | "bet_amount" | "odds_at_bet_time" | "potential_payout" | "status" | "settled_at", ExtArgs["result"]["bets"]>
...
export interface betsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const betsWithBet_idOnly = await prisma.bets.findMany({ select: { bet_id: true } })
   * 
   */
   ...
   * const betsWithBet_idOnly = await prisma.bets.createManyAndReturn({
   *   select: { bet_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * const betsWithBet_idOnly = await prisma.bets.updateManyAndReturn({
   *   select: { bet_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface betsFieldRefs {
  readonly bet_id: Prisma.FieldRef<"bets", 'String'>
  readonly created_at: Prisma.FieldRef<"bets", 'DateTime'>
  readonly user_id: Prisma.FieldRef<"bets", 'String'>
  readonly match_id: Prisma.FieldRef<"bets", 'String'>
  readonly predicted_winner: Prisma.FieldRef<"bets", 'String'>
  readonly bet_amount: Prisma.FieldRef<"bets", 'Decimal'>
  readonly odds_at_bet_time: Prisma.FieldRef<"bets", 'Decimal'>
  readonly potential_payout: Prisma.FieldRef<"bets", 'Decimal'>
  readonly status: Prisma.FieldRef<"bets", 'bet_status'>
  readonly settled_at: Prisma.FieldRef<"bets", 'DateTime'>
}
